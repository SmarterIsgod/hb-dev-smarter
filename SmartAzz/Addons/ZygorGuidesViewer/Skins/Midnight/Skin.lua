...
function AssignButtonTexture(obj,tx,num,total)
	obj:SetNormalTexture(CreateTexWithCoordsNum(obj,tx,num,total,1,4))
	obj:SetPushedTexture(CreateTexWithCoordsNum(obj,tx,num,total,2,4))
	obj:SetHighlightTexture(CreateTexWithCoordsNum(obj,tx,num,total,3,4))
	obj:SetDisabledTexture(CreateTexWithCoordsNum(obj,tx,num,total,4,4))
end
...
function skin:UpdateSkin()
	...
	ZGV.ChainCall(ZygorGuidesViewerFrame_Border_Guides.GuideBack)
	...
	ZGV.ChainCall(ZygorGuidesViewerFrame_Border_Guides.StepnumBack)
	...
	ZGV.ChainCall(ZygorGuidesViewerFrame_Border.TabBack)
		:SetBackdrop({bgFile = ZGV.DIR.."\\Skins\\white"})
		:SetFrameLevel(1)
...
function skin:AlignFrame()
	...
	frame.Border.TitleBar:ClearAllPoints()
	frame.Border.TitleBar:SetPoint(UP_TOPLEFT,frame.Border,UP_TOPLEFT,0,0)
	frame.Border.TitleBar:SetPoint(UP_TOPRIGHT,frame.Border,UP_TOPRIGHT,0,0)
	...
	frame.Border.Tab1:ClearAllPoints()
	frame.Border.Tab1:SetPoint("LEFT",frame.Border.TitleBar,UP_BOTTOMLEFT,5,-10*UP)

	frame.Border.Guides:ClearAllPoints()
	frame.Border.Guides:SetPoint(UP_TOPLEFT,frame.Border.TitleBar,UP_BOTTOMLEFT,0,-tabbar_height*UP)
	frame.Border.Guides:SetPoint("RIGHT",frame.Border.TitleBar,"RIGHT",0,0)

	frame.Border.Gold:ClearAllPoints()
	frame.Border.Gold:SetPoint(UP_TOPLEFT,frame.Border.TitleBar,UP_BOTTOMLEFT,0,-tabbar_height*UP)
	frame.Border.Gold:SetPoint("RIGHT",frame.Border.TitleBar,"RIGHT",0,0)
	...
	ZygorGuidesViewerFrame_Scroll:SetPoint(UP_TOPLEFT,frame.Border,UP_TOPLEFT,10,(-tabbar_height-55)*UP)
	ZygorGuidesViewerFrame_Scroll:SetPoint(UP_BOTTOMRIGHT,frame.Border,UP_BOTTOMRIGHT,-10,10*UP)

	-- resizers
	ZygorGuidesViewerFrame_ResizerBottom:ClearAllPoints()
	ZygorGuidesViewerFrame_ResizerBottom:SetPoint(UP_BOTTOMLEFT,10,0)
	ZygorGuidesViewerFrame_ResizerBottom:SetPoint(UP_TOPRIGHT,frame,UP_BOTTOMRIGHT,-10,10*UP)
	...
	ZygorGuidesViewerFrame_Border_Flash_Left:SetPoint(UP_BOTTOMRIGHT,frame,UP_BOTTOMLEFT,9,10*UP)

	ZygorGuidesViewerFrame_Border_Flash_Right:ClearAllPoints()
	ZygorGuidesViewerFrame_Border_Flash_Right:SetPoint(UP_TOPLEFT,frame,UP_TOPRIGHT,-10,-35*UP)
	ZygorGuidesViewerFrame_Border_Flash_Right:SetPoint(UP_BOTTOMRIGHT,frame,UP_BOTTOMRIGHT,16,10*UP)
	...
	ZygorGuidesViewerFrame_Border_Flash_Bottom:SetPoint(UP_TOPLEFT,frame,UP_BOTTOMLEFT,13,9*UP)
	ZygorGuidesViewerFrame_Border_Flash_Bottom:SetPoint(UP_BOTTOMRIGHT,frame,UP_BOTTOMRIGHT,-13,-15*UP)
